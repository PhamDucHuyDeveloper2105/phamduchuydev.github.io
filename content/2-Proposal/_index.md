...
## English Study Online Platform on AWS Cloud

### 1. Executive Summary

The **English Study Online System** is a web-based application that enables students to enroll in English courses online, browse available courses, track their learning progress, and receive notifications. The system also assists teachers and administrators in managing courses, lessons, student records, and daily platform operations.

The system is built on a **Cloud Native Architecture** using AWS services to provide high availability, security, scalability, and performance. The frontend is deployed using **AWS Amplify**, while the backend is developed with **Spring Boot** and hosted on **Amazon EC2**. Application data is stored in **Amazon DynamoDB**, course materials and uploaded files are stored in **Amazon S3**, and services such as **CloudWatch, SNS, SES, AWS WAF, IAM, Secrets Manager, and AWS KMS** are integrated to ensure reliable and secure operation.
...
Many language centers still manage course enrollment manually through phone calls or paper-based records, which leads to several issues:

- Difficult enrollment management.
- Scheduling conflicts and errors.
- Inefficient student information management.
- No automatic notification system.
- Limited scalability as the number of students increases.

### Proposed Solution

The **English Study Online System** provides a cloud-based e-learning platform running on AWS Cloud.
...
- Cancel enrollments.
- Browse available English courses.
...
Application data is stored in **Amazon DynamoDB**, while course materials and uploaded files are stored in **Amazon S3**.

Sensitive configuration data is securely managed using **AWS Secrets Manager** and encrypted with **AWS KMS**.

**Amazon CloudWatch** monitors system resources, while **Amazon SNS** and **Amazon SES** deliver alerts and enrollment confirmation emails.
...
- **Amazon DynamoDB:** Stores users, teachers, courses, lessons, enrollments, and other application data.
- **Amazon S3:** Stores teacher images, course images, user uploads, and static files.
...
- **Amazon SES:** Sends enrollment confirmations, reminders, and email notifications.
...
1. **Requirement Analysis and System Design:** Analyze the requirements of the online learning platform, identify core features such as user management, teacher management, course enrollment, and lesson management, then design the database, user interface, and AWS Cloud architecture.
...
- Amazon S3 for storing course materials and uploaded files.

**Monitoring and Notification**

- Amazon CloudWatch for monitoring logs and resources.
- Amazon SNS for operational notifications.
- Amazon SES for enrollment confirmation and reminder emails.
...
- Successfully develop an online English study platform.
...
- Support future features such as online payment, AI chatbot, and learning analytics.