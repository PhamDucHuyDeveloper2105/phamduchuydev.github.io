...
Trong phần này, chúng ta sẽ lần lượt xóa các tài nguyên đã sử dụng trong quá trình triển khai **English Study Online System**. 
...
> **Lưu ý:** Trong Workshop này, nhóm **không thực hiện xóa Email Identity trên Amazon SES** vì vẫn tiếp tục sử dụng để gửi email xác nhận đăng ký và các thông báo từ hệ thống.
