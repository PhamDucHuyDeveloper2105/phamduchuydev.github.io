...
Để khắc phục các vấn đề trên, hệ thống được xây dựng theo kiến trúc **3-Tier Architecture**, sử dụng **ReactJS** cho Frontend, **Spring Boot** cho Backend và **Amazon RDS** làm cơ sở dữ liệu NoSQL. Việc triển khai trên AWS giúp hệ thống có khả năng mở rộng linh hoạt, tăng tính sẵn sàng, đảm bảo bảo mật và giảm chi phí quản lý hạ tầng.
...
3. [Cấu hình RDS Database](5.3-Configure-RDS-Database/)
