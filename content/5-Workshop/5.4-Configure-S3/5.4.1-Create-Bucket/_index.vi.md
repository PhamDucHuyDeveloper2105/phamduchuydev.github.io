...
Trong bước này, chúng ta sẽ tạo một **Amazon S3 Bucket** để lưu trữ hình ảnh của hệ thống **English Study Online**.
...
Chọn Bucket **english-study-online-images-huy** để kiểm tra các đối tượng lưu trữ.

Trong Bucket, hệ thống đã tổ chức các thư mục để quản lý hình ảnh theo từng chức năng:

- **avatars/**: Lưu ảnh đại diện.
- **courses/**: Lưu hình ảnh khóa học.
- **lessons/**: Lưu hình ảnh bài học.
